...
x = a  // calcula o primeiro erro relativo, também poderia ser b

while (1)
    x_anterior = x
    x = (a + b) / 2  // ponto médio do intervalo
    erro_relativo = abs((x - x_anterior) / x)  // cálculo do erro relativo
    if (erro_relativo < 10^-3) then  // teste de saída do laço while
        break
    end
